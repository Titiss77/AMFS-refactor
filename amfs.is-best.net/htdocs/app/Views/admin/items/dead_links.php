...
<div class="container">
    ...
    <p>Ces cartes possèdent des URL de visionnage qui ont été identifiées comme cassées ou inaccessibles par le robot de
        maintenance hebdomadaire.</p>
                ...
                <tr style="background-color: #fff8f8;">
                    ...
                    <td>
                        <div class="action-links">
                            <a href="<?= base_url('item/form/' . $item->id) ?>" class="btn-action btn-edit">Mettre à
                                jour</a>
                            <a href="<?= esc($item->lien) ?>" target="_blank" class="btn-action"
